...
// Monday.com integration - updated token and simplified field formatting
$monday_api_token = 'eyJhbGciOiJIUzI1NiJ9.eyJ0aWQiOjYxODExMjQ1OSwiYWFpIjoxMSwidWlkIjo5OTA1NDE2MiwiaWFkIjoiMjAyNi0wMi0wNlQxNzoxOToxOC44NTZaIiwicGVyIjoibWU6d3JpdGUiLCJhY3RpZCI6OTgyMzU5MCwicmduIjoidXNlMSJ9.8r21EvMe8R2_9gPw6uq9-3FmyCIj0IYGjlhRHBSLRQk';
...
try {
    ...
    // Use the correct column IDs now
    $column_values = [
        'text' => $first_name,
        'text_1' => $last_name,
        'text_mm04w6jq' => $email,               // Correct Email ID
        'phone_mm06bhs1' => $phone,              // Working Phone ID
        'text_mm02dymw' => $net_worth ?: '',     // Working Net Worth ID
        'text_mm04fbs8' => $accredited ?: '',    // Correct Accredited ID
        'text_mm044z4k' => $interest ?: '',      // Correct Interest ID
        'text_mm026pc4' => $message ?: ''        // Correct Message ID
    ];
