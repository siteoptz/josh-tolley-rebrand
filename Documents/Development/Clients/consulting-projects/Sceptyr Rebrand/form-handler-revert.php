...
// Monday.com integration - EXACT working configuration
...
try {
    ...
    // ONLY use the column IDs that were actually working
    $column_values = [
        'text' => $first_name,              // ✅ This was working
        'phone' => $phone,                  // ✅ This was working (not phone_mm06bhs1)
        'text_mm02dymw' => $net_worth ?: '' // ✅ This was working
    ];
